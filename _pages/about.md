...
I have also developed the **[Global GPS Telemetry Studies Database (MoveDB)](https://nilanjanchatterjee.github.io/movedb/)**, an open-access spatial database of over 75,000 published mammalian GPS telemetry studies worldwide — enabling researchers to discover prior work, avoid duplication, and build on existing data.
